...
const BusinessCartPage = () => {
    ...
    const [cartItems, setCartItems] = useState([
        {
            id: '1',
            title:
                'High Quality Velvet Shawl & Stone works, Comfortable Soft Winter Wear Velvet Chador',
            brand: 'No Brand',
            size: 'Int: One size',
            color: 'Black',
            price: 250,
            ...
            discount: 75,
            quantity: 1,
            image: '/img/product/shopping-cart-1.png',
        },
        {
            id: '2',
            title:
    ...
    const handleSelectItem = itemId => {
        if (itemId === 'selectAll') {
            // Handle the case when "SELECT ALL" checkbox is clicked
            const allItemIds = cartItems.map(item => item.id)
            setSelectedItems(prevSelectedItems =>
                prevSelectedItems.length === allItemIds.length
                    ? []
                    : allItemIds,
            )
        } else {
            // Handle the case when individual item checkbox is clicked
            setSelectedItems(prevSelectedItems => {
    ...
    const handleDeleteSelected = () => {
        // Implement the logic to perform the delete action
        // For example: show an alert or log a message
        if (selectedItems.length > 0) {
            alert(`Deleting selected items: ${selectedItems.join(', ')}`)
        } else {
                    ...
                    <div className="business-wrapper">
                        <div className="business-cart-item-select">
                            <div className="business-select-count">
                                ...
                                <button
                                    className="business-select-delete d-flex"
                        ...
                        <div className="business-cart-item">
                            <div className="shopping-cart-con">
                                ...
                                <div className="shopping-cart-wrapper">
                                    {cartItems.map(item => (
                                        <div
                                            className="shopping-cart-item mb-3"
                                            key={item.id}>
                                            ...
                                            <div className="shopping-cart-item-content">
                                                ...
                                                <div>
                                                    ...
                                                    <div className="shopping-cart-price-item">
                                                        ...
                                                        <div className="shopping-deleting-btn d-flex align-items-center gap-2">
